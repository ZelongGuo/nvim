...
-- Disabled cursor movement (hjik) in Select Mode for inderting text
vim.keymap.set("s", "h", "h", { noremap = true, silent = true })
vim.keymap.set("s", "i", "i", { noremap = true, silent = true })
